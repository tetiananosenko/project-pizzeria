...

{
  ...
  class Product {
    ...
    initAmountWidget() {
      ...
      // console.log('thisProduct.amountWidget', thisProduct.dom.amountWidgetElem);
    }
    addToCart() {
      const thisProduct = this;
    ...
    prepareCartProduct() {
      ...
      console.log('id2', productSummary);
  ...
  class AmountWidget {
    ...
    setValue(value) {
      ...
      if (!isNaN(newValue) && thisWidget.value !== newValue && settings.amountWidget.defaultMin <= newValue && settings.amountWidget.defaultMax >= newValue) {
  ...
  class Cart {
    ...
    getElements(element) {
      const thisCart = this;
      console.log('ggg',document.querySelector(select.templateOf.cartProduct))
      thisCart.dom = {
        wrapper: element,
    ...
    initAmountWidget() {
      ...
      console.log('thisProduct.amountWidget', thisProduct.amountWidgetElem);
    }
    add(menuProduct) {
      const thisCart = this;
  ...
  const app = {
    initMenu: function () {
      ...
      for (let productData in thisApp.data.products) {
        ...
        // console.log('thisApp.data.products[productData]', thisApp.data.products[productData].name)
      }
    },
    initData: function () {
      const thisApp = this;
